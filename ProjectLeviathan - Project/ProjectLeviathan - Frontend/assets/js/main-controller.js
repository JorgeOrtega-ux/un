...
function initMainController() {
    ...
    // --- INICIO DE LA MODIFICACIÓN: Variables para WebSocket ---
    let websocket = null;
    ...
    // --- INICIO DE LA MODIFICACIÓN: Lógica de chat con WebSocket ---
    ...
    const loadChat = async (groupInfo) => {
        ...
        try {
            // 1. Obtener detalles del grupo (título)
            const detailsResponse = await fetch(`${window.PROJECT_CONFIG.apiUrl}?action=get_group_details&group_uuid=${groupInfo.uuid}`);
            ...
            if (detailsData.success) {
                ...
                alert(detailsData.message || 'Ocurrió un error inesperado.');
                handleNavigationChange('home');
            }
        } catch (error) {
    ...
    const handleNavigationChange = (section, subsection = null, updateUrl = true) => {
        ...
        // --- INICIO DE LA MODIFICACIÓN: Desconectar WebSocket si salimos del chat ---
    ...
    function setupEventListeners() {
        ...
        // --- INICIO DE LA MODIFICACIÓN: Enviar mensaje de chat ---
